...
public static class SchemaOptionDefaults
{
    public static IReadOnlyList<ColumnModel> Prefix { get; } = new[]
    {
        new ColumnModel { Name = "ASAP_RecordEffectiveDateTime", DataType = "datetime2(7)", NotNull = true, Private = true },
        new ColumnModel { Name = "ASAP_DeleteDateTime", DataType = "nvarchar(10)", Private = true },
    };

    public static IReadOnlyList<ColumnModel> Sufix { get; } = new[]
    {
        new ColumnModel { Name = "ASAP_ROW_HASH", DataType = "nvarchar(64)", Private = true },
        new ColumnModel { Name = "ASAP_DML_FLAG", DataType = "nvarchar(2)", Private = true },
        new ColumnModel { Name = "ASAP_CREATED_DATE", DataType = "datetime2(7)", Private = true },
        new ColumnModel { Name = "ASAP_UPDATED_DATE", DataType = "datetime2(7)", Private = true },
        new ColumnModel { Name = "ASAP_LINEAGE_ID", DataType = "nvarchar(36)", Private = true },
        new ColumnModel { Name = "ASAP_ACTIVITY_ID", DataType = "nvarchar(36)", Private = true },
        new ColumnModel { Name = "ASAP_TRIGGER_ID", DataType = "nvarchar(36)", Private = true },
        new ColumnModel { Name = "ASAP_SRC_FILEPATH", DataType = "nvarchar(1000)", Private = true },
        new ColumnModel { Name = "ASAP_SRC_FILE_DATE", DataType = "datetime2(7)", Private = true },
        new ColumnModel { Name = "ASAP_SRC_NAME", DataType = "nvarchar(36)", Private = false },
    };
