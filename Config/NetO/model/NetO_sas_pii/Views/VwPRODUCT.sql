...
AS
   SELECT
      x.[LNUM] AS [LNUM],
      x.[S_PROD] AS [S_PROD],
      A0.Descript AS [D_PROD],
      x.[S_RATE] AS [S_RATE],
      A1.Descript AS [D_RATE],
      x.[S_RTCODE] AS [S_RTCODE],
      A2.Descript AS [D_RTCODE],
      x.[OLA] AS [OLA],
      x.[LTV] AS [LTV],
      x.[S_LCKTYP] AS [S_LCKTYP],
      A3.Descript AS [D_LCKTYP],
      ...
      A4.Descript AS [D_LCKEXP],
      x.[S_RATIO] AS [S_RATIO],
      A5.Descript AS [D_RATIO],
      x.[S_BYDOWN] AS [S_BYDOWN],
      A6.Descript AS [D_BYDOWN],
      x.[S_MIPLAN] AS [S_MIPLAN],
      A7.Descript AS [D_MIPLAN],
      ...
      A8.Descript AS [D_PMTSTR],
      x.[S_DISC] AS [S_DISC],
      A9.Descript AS [D_DISC],
      x.[S_ORIG] AS [S_ORIG],
      A10.Descript AS [D_ORIG],
      x.[BASELA] AS [BASELA],
      x.[LOCKED] AS [LOCKED],
      x.[S_QRATE] AS [S_QRATE],
      A11.Descript AS [D_QRATE],
      ...
      A12.Descript AS [D_RTCODEOVR],
      x.[S_LTYPE] AS [S_LTYPE],
      A13.Descript AS [D_LTYPE],
      x.[S_PROGRM] AS [S_PROGRM],
      A14.Descript AS [D_PROGRM],
      ...
      A15.Descript AS [D_AMTYPE],
      x.[SELRTCODE] AS [SELRTCODE],
      x.[S_RCOMNUM] AS [S_RCOMNUM],
      A16.Descript AS [D_RCOMNUM],
      ...
      A17.Descript AS [D_BALLOON_TYPE],
      ...
      A18.Descript AS [D_MORTGAGETYPE],
      ...
      A19.Descript AS [D_AMORT_SUB_TYPE],
      x.[QUALMETHOD] AS [QUALMETHOD],
      x.[S_QUALMETHODOVR] AS [S_QUALMETHODOVR],
      A20.Descript AS [D_QUALMETHODOVR],
      x.[YSP] AS [YSP],
      ...
      A24.Descript AS [D_PROD_PRICE_ENGINE],
      x.[S_PROD_PRICE_ENGINE_OVR] AS [S_PROD_PRICE_ENGINE_OVR],
      A25.Descript AS [D_PROD_PRICE_ENGINE_OVR],
      x.[S_PPY_FILTER] AS [S_PPY_FILTER],
      A26.Descript AS [D_PPY_FILTER],
