...
AS
   SELECT
      ...
      A0.Descript AS [D_DISPOSITION],
      x.[S_UWOPT1] AS [S_UWOPT1],
      A1.Descript AS [D_UWOPT1],
      x.[S_UWOPT2] AS [S_UWOPT2],
      A2.Descript AS [D_UWOPT2],
      x.[S_UWOPT3] AS [S_UWOPT3],
      A3.Descript AS [D_UWOPT3],
      x.[S_UWOPT4] AS [S_UWOPT4],
      A4.Descript AS [D_UWOPT4],
      x.[S_UWOPT5] AS [S_UWOPT5],
      A5.Descript AS [D_UWOPT5],
      x.[S_UWOPT6] AS [S_UWOPT6],
      A6.Descript AS [D_UWOPT6],
      ...
      A8.Descript AS [D_CREDSCORE_OVERRIDE_REASON],
