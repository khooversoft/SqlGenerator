...
CREATE VIEW [NetO_sas_pii].[VwGF_TLR_RSP_LP_LOANFDBCK]
AS
   SELECT
      x.[LNUM] AS [LNUM],
      x.[DBID] AS [DBID],
      ...
      x.[CREDSCOREDATAREPOSSRCTYPE] AS [CREDSCOREDATAREPOSSRCTYPE],
      x.[SCOREDBORROWERNAME] AS [SCOREDBORROWERNAME],
      x.[CREDITSCOREVALUE] AS [CREDITSCOREVALUE],
      x.[HOUSINGRATIOPERCENT] AS [HOUSINGRATIOPERCENT],
      x.[DEBTRATIOPERCENT] AS [DEBTRATIOPERCENT],
      ...
      x.[FREHUDSCOREDINDICATOR] AS [FREHUDSCOREDINDICATOR],
      ...
      x.[CREDITREPORTIDENTIFIER] AS [CREDITREPORTIDENTIFIER],
      x.[DOCCHECKLSTRPT] AS [DOCCHECKLSTRPT],
      x.[DOCCHECKLST_SER] AS [DOCCHECKLST_SER],
      x.[FEEDBACKRPT] AS [FEEDBACKRPT],
      ...
      x.[DOCCHECKLISTIMAGEID] AS [DOCCHECKLISTIMAGEID],
      ...
      A0.Descript AS [S_CRWELIGIBILITYTYPEDescription],
