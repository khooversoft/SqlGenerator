...
CREATE VIEW [NetO_sas_pii].[VwPREVRES]
AS
   SELECT
      x.[LNUM] AS [LNUM],
      x.[BNUM] AS [BNUM],
      ...
      A0.Descript AS [S_OWNRNTDescription],
      ...
      A1.Descript AS [S_RES_UNIT_TYPEDescription],
      ...
      A2.Descript AS [S_LIVE_RENT_FREE_ENUMSDescription]
