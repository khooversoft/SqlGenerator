...
AS
   SELECT
      ...
      A2.Descript AS [D_BORTYP],
      x.[ALIASES] AS [ALIASES],
      x.[S_VESTNG] AS [S_VESTNG],
      A3.Descript AS [D_VESTNG],
      ...
      A6.Descript AS [D_LEGAL_ENTITY_TYPE],
      x.[S_LEGAL_ENTITY_TYP_OTH] AS [S_LEGAL_ENTITY_TYP_OTH],
      A7.Descript AS [D_LEGAL_ENTITY_TYP_OTH],
      ...
      A10.Descript AS [D_PARTY_TYPE],
      x.[S_CITIZENSHIP] AS [S_CITIZENSHIP],
      A11.Descript AS [D_CITIZENSHIP],
      x.[S_UNMARRIED] AS [S_UNMARRIED],
      A12.Descript AS [D_UNMARRIED],
      ...
      A13.Descript AS [D_UNMARRIED_RLTNSHIP],
