...
CREATE VIEW [NetO_sas_pii].[VwWG_BRM_IMPORT]
AS
   SELECT
      ...
      A0.Descript AS [S_IMP_STATUSDescription],
      ...
      A1.Descript AS [S_EXP_STATUSDescription],
      ...
      A2.Descript AS [S_EXP_BRM_STATUSDescription],
