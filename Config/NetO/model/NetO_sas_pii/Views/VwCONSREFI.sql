...
AS
   SELECT
      ...
      A0.Descript AS [S_REFPRPDescription],
      ...
      A4.Descript AS [S_CONST_PERM_FEATUREDescription],
      x.[S_FNM_REFI_PGM] AS [S_FNM_REFI_PGM],
      A5.Descript AS [S_FNM_REFI_PGMDescription],
      x.[S_FRE_REFI_PGM] AS [S_FRE_REFI_PGM],
      A6.Descript AS [S_FRE_REFI_PGMDescription],
