...
CREATE VIEW [NetO_sas_pii].[VwLIABLTY]
AS
   SELECT
      x.[LNUM] AS [LNUM],
      x.[BNUM] AS [BNUM],
      ...
      x.[S_LIAB] AS [S_LIAB],
      A0.Descript AS [S_LIABDescription],
      ...
      A2.Descript AS [S_LIENPSDescription],
      ...
      A3.Descript AS [S_EXCLUSION_REASONDescription],
      x.[S_MTG_TYPE] AS [S_MTG_TYPE],
      A4.Descript AS [S_MTG_TYPEDescription],
      ...
      A5.Descript AS [S_CREDIT_CARD_TYPEDescription],
      ...
      A6.Descript AS [S_LIABILITYDISBTYPEDescription],
      ...
      A7.Descript AS [S_ACCOUNT_OWNERSHIPDescription],
