...
CREATE VIEW [NetO_sas_pii].[VwWG_BRM_LKUP_BASE]
AS
   SELECT
      x.[BRMID] AS [BRMID],
      ...
      A1.Descript AS [S_BRM_STATUSDescription],
      x.[S_BRM_TYPE] AS [S_BRM_TYPE],
      A2.Descript AS [S_BRM_TYPEDescription],
      ...
      A3.Descript AS [S_CAP_CATEGORYDescription],
      x.[S_EFFECTIVITY_RULE] AS [S_EFFECTIVITY_RULE],
      A4.Descript AS [S_EFFECTIVITY_RULEDescription],
      ...
      A5.Descript AS [S_OVERRIDE_LEVELDescription],
