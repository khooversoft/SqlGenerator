...
AS
   SELECT
      ...
      A0.Descript AS [D_AUINDICATOR],
      x.[S_SERVICE_TYPE_IND] AS [S_SERVICE_TYPE_IND],
      A1.Descript AS [D_SERVICE_TYPE_IND],
      ...
      A3.Descript AS [D_LOANFIT_PURP_CAT],
      x.[S_LOANFIT_PROD_CAT] AS [S_LOANFIT_PROD_CAT],
      A4.Descript AS [D_LOANFIT_PROD_CAT],
      x.[S_LOANFIT_LIEN_CAT] AS [S_LOANFIT_LIEN_CAT],
      A5.Descript AS [D_LOANFIT_LIEN_CAT],
      ...
      A6.Descript AS [D_LOANFIT_AMT_GROUP],
      x.[S_LOANFIT_LTV_GROUP] AS [S_LOANFIT_LTV_GROUP],
      A7.Descript AS [D_LOANFIT_LTV_GROUP],
      ...
      A8.Descript AS [D_CONST_PROGRAM],
      ...
      A9.Descript AS [D_ASSUMABILITY_FEATURE],
      x.[S_IPG_BUYDWN] AS [S_IPG_BUYDWN],
      A10.Descript AS [D_IPG_BUYDWN],
      x.[S_BUYDWN_CNTRBTR] AS [S_BUYDWN_CNTRBTR],
      A11.Descript AS [D_BUYDWN_CNTRBTR]
