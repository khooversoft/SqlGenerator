...
AS
   SELECT
      ...
      A0.[Descript] AS [S_LOAN_STATUS_X],
      x.[S_UW_STATUS] AS [S_UW_STATUS],
      x.[S_LOCK_STATUS] AS [S_LOCK_STATUS],
      A1.[Descript] AS [S_LOCK_STATUS_X],
   ...
   FROM [clt_NetO].[GF_TL_LOAN_STATUS] x
      ...
      LEFT JOIN [clt_NetO].[SymbolLookup] A1 on x.[S_LOCK_STATUS] = A1.[DBSYMBOL] AND A1.[TableName] = 'GF_TL_LOAN_STATUS' and A1.[COLUMNNAME] = 'S_LOCK_STATUS'
   WHERE
