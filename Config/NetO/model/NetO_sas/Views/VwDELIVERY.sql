...
AS
   SELECT
      x.[LNUM] AS [LNUM],
      x.[COMNUM] AS [COMNUM],
      HASHBYTES('SHA2_256', x.[CONTRACT]) AS [CONTRACT],
      ...
      HASHBYTES('SHA2_256', CAST(x.[RENTS1] AS NVARCHAR(50))) AS [RENTS1],
      HASHBYTES('SHA2_256', CAST(x.[RENTS2] AS NVARCHAR(50))) AS [RENTS2],
      HASHBYTES('SHA2_256', CAST(x.[RENTS3] AS NVARCHAR(50))) AS [RENTS3],
      HASHBYTES('SHA2_256', CAST(x.[RENTS4] AS NVARCHAR(50))) AS [RENTS4],
      x.[S_SPF1] AS [S_SPF1],
      A0.[Descript] AS [S_SPF1_X],
      x.[S_SPF2] AS [S_SPF2],
      A1.[Descript] AS [S_SPF2_X],
      x.[S_SPF3] AS [S_SPF3],
      A2.[Descript] AS [S_SPF3_X],
      x.[S_SPF4] AS [S_SPF4],
      A3.[Descript] AS [S_SPF4_X],
      x.[S_SPF5] AS [S_SPF5],
      A4.[Descript] AS [S_SPF5_X],
      x.[S_SPF6] AS [S_SPF6],
      A5.[Descript] AS [S_SPF6_X],
      x.[ASSUM] AS [ASSUM],
      x.[RDF] AS [RDF],
      x.[INTPD] AS [INTPD],
      x.[MATDATE] AS [MATDATE],
      x.[S_SFSRC1] AS [S_SFSRC1],
      A6.[Descript] AS [S_SFSRC1_X],
      x.[S_SFSRC2] AS [S_SFSRC2],
      A7.[Descript] AS [S_SFSRC2_X],
      x.[SFAMT1] AS [SFAMT1],
      x.[SFAMT2] AS [SFAMT2],
      x.[S_BECA1] AS [S_BECA1],
      A8.[Descript] AS [S_BECA1_X],
      x.[S_BECA2] AS [S_BECA2],
      A9.[Descript] AS [S_BECA2_X],
      x.[S_BECF1] AS [S_BECF1],
      A10.[Descript] AS [S_BECF1_X],
      x.[S_BECF2] AS [S_BECF2],
      A11.[Descript] AS [S_BECF2_X],
      x.[S_DPSRC1] AS [S_DPSRC1],
      A12.[Descript] AS [S_DPSRC1_X],
      x.[S_DPSRC2] AS [S_DPSRC2],
      A13.[Descript] AS [S_DPSRC2_X],
      x.[S_DPSRC3] AS [S_DPSRC3],
      A14.[Descript] AS [S_DPSRC3_X],
      x.[S_DPSRC4] AS [S_DPSRC4],
      A15.[Descript] AS [S_DPSRC4_X],
      x.[DPAMT1] AS [DPAMT1],
      x.[DPAMT2] AS [DPAMT2],
      x.[DPAMT3] AS [DPAMT3],
      x.[DPAMT4] AS [DPAMT4],
      x.[S_CCSRC1] AS [S_CCSRC1],
      A16.[Descript] AS [S_CCSRC1_X],
      x.[S_CCSRC2] AS [S_CCSRC2],
      A17.[Descript] AS [S_CCSRC2_X],
      x.[S_CCSRC3] AS [S_CCSRC3],
      A18.[Descript] AS [S_CCSRC3_X],
      x.[S_CCSRC4] AS [S_CCSRC4],
      A19.[Descript] AS [S_CCSRC4_X],
      HASHBYTES('SHA2_256', CAST(x.[CCAMT1] AS NVARCHAR(50))) AS [CCAMT1],
      HASHBYTES('SHA2_256', CAST(x.[CCAMT2] AS NVARCHAR(50))) AS [CCAMT2],
      HASHBYTES('SHA2_256', CAST(x.[CCAMT3] AS NVARCHAR(50))) AS [CCAMT3],
      HASHBYTES('SHA2_256', CAST(x.[CCAMT4] AS NVARCHAR(50))) AS [CCAMT4],
      x.[MICOV] AS [MICOV],
      x.[UPB] AS [UPB],
      x.[S_LFC] AS [S_LFC],
      A20.[Descript] AS [S_LFC_X],
      x.[INTEND] AS [INTEND],
      x.[LPID] AS [LPID],
      ...
      x.[S_RFC] AS [S_RFC],
      A21.[Descript] AS [S_RFC_X],
      x.[UWNAME] AS [UWNAME],
      x.[INVLNUM] AS [INVLNUM],
      HASHBYTES('SHA2_256', x.[MTGORIG]) AS [MTGORIG],
      x.[TP1] AS [TP1],
      x.[TP2] AS [TP2],
      x.[MAXTERM] AS [MAXTERM],
      HASHBYTES('SHA2_256', x.[SELLER]) AS [SELLER],
      HASHBYTES('SHA2_256', CAST(x.[CID_SELLER_AGENT] AS NVARCHAR(50))) AS [CID_SELLER_AGENT],
      x.[S_SPF7] AS [S_SPF7],
      A22.[Descript] AS [S_SPF7_X],
      x.[S_SPF8] AS [S_SPF8],
      A23.[Descript] AS [S_SPF8_X],
      x.[S_SPF9] AS [S_SPF9],
      A24.[Descript] AS [S_SPF9_X],
      x.[S_SPF10] AS [S_SPF10],
      A25.[Descript] AS [S_SPF10_X],
      x.[UPBO] AS [UPBO],
      ...
      A31.[Descript] AS [S_SIGNDOCPUSHBACK_X],
