...
CREATE VIEW [NetO_sas].[VwGF_TW_WF_ACTION_MGR]
AS
   SELECT
      x.[ACTION_ID] AS [ACTION_ID],
      x.[S_WORKTYPE] AS [S_WORKTYPE],
      A0.Descript AS [S_WORKTYPEDescription],
      x.[S_ACTION_RESOLUTION] AS [S_ACTION_RESOLUTION],
      A1.Descript AS [S_ACTION_RESOLUTIONDescription],
      x.[S_PROC_MDL_RESOLUTION] AS [S_PROC_MDL_RESOLUTION],
      A2.Descript AS [S_PROC_MDL_RESOLUTIONDescription],
      ...
      A3.Descript AS [S_PROC_GROUPDescription],
