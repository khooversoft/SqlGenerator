...
AS
   SELECT
      ...
      A0.Descript AS [D_IVMETH],
      x.[S_IVID] AS [S_IVID],
      A1.Descript AS [D_IVID],
      x.[S_BUSCHL] AS [S_BUSCHL],
      A2.Descript AS [D_BUSCHL],
      ...
      A3.Descript AS [D_COPT1],
      x.[S_COPT2] AS [S_COPT2],
      A4.Descript AS [D_COPT2],
      x.[S_COPT3] AS [S_COPT3],
      A5.Descript AS [D_COPT3],
      x.[S_COPT4] AS [S_COPT4],
      A6.Descript AS [D_COPT4],
      x.[S_COPT5] AS [S_COPT5],
      A7.Descript AS [D_COPT5],
      ...
      A8.Descript AS [D_COPT6],
      x.[S_COPT7] AS [S_COPT7],
      A9.Descript AS [D_COPT7],
      x.[S_COPT8] AS [S_COPT8],
      A10.Descript AS [D_COPT8],
      x.[S_COPT9] AS [S_COPT9],
      A11.Descript AS [D_COPT9],
      x.[S_COPT10] AS [S_COPT10],
      A12.Descript AS [D_COPT10],
      x.[S_CRDGRDRQ] AS [S_CRDGRDRQ],
      A13.Descript AS [D_CRDGRDRQ],
      x.[S_DOCLEVEL] AS [S_DOCLEVEL],
      A14.Descript AS [D_DOCLEVEL],
      x.[GRADEDC] AS [GRADEDC],
      x.[S_CRDGRDAP] AS [S_CRDGRDAP],
      A15.Descript AS [D_CRDGRDAP],
      x.[S_QUALITY] AS [S_QUALITY],
      A16.Descript AS [D_QUALITY],
      ...
      A18.Descript AS [D_CASE_STATUS],
      x.[S_REPAY] AS [S_REPAY],
      A19.Descript AS [D_REPAY],
      ...
      A20.Descript AS [D_CHANNEL_SOURCE_CODE],
