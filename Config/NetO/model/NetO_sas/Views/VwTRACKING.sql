...
AS
   SELECT
      ...
      A0.Descript AS [S_IVMETHDescription],
      x.[S_IVID] AS [S_IVID],
      A1.Descript AS [S_IVIDDescription],
      x.[S_BUSCHL] AS [S_BUSCHL],
      A2.Descript AS [S_BUSCHLDescription],
      ...
      A3.Descript AS [S_COPT1Description],
      x.[S_COPT2] AS [S_COPT2],
      A4.Descript AS [S_COPT2Description],
      x.[S_COPT3] AS [S_COPT3],
      A5.Descript AS [S_COPT3Description],
      x.[S_COPT4] AS [S_COPT4],
      A6.Descript AS [S_COPT4Description],
      x.[S_COPT5] AS [S_COPT5],
      A7.Descript AS [S_COPT5Description],
      ...
      A8.Descript AS [S_COPT6Description],
      x.[S_COPT7] AS [S_COPT7],
      A9.Descript AS [S_COPT7Description],
      x.[S_COPT8] AS [S_COPT8],
      A10.Descript AS [S_COPT8Description],
      x.[S_COPT9] AS [S_COPT9],
      A11.Descript AS [S_COPT9Description],
      x.[S_COPT10] AS [S_COPT10],
      A12.Descript AS [S_COPT10Description],
      x.[S_CRDGRDRQ] AS [S_CRDGRDRQ],
      A13.Descript AS [S_CRDGRDRQDescription],
      x.[S_DOCLEVEL] AS [S_DOCLEVEL],
      A14.Descript AS [S_DOCLEVELDescription],
      x.[GRADEDC] AS [GRADEDC],
      x.[S_CRDGRDAP] AS [S_CRDGRDAP],
      A15.Descript AS [S_CRDGRDAPDescription],
      x.[S_QUALITY] AS [S_QUALITY],
      A16.Descript AS [S_QUALITYDescription],
      ...
      A17.Descript AS [S_DELTERMSDescription],
      x.[SELLCL] AS [SELLCL],
      ...
      A18.Descript AS [S_CASE_STATUSDescription],
      x.[S_REPAY] AS [S_REPAY],
      A19.Descript AS [S_REPAYDescription],
      ...
      A20.Descript AS [S_CHANNEL_SOURCE_CODEDescription],
