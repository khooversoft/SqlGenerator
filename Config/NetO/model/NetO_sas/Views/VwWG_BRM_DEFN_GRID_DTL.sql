...
CREATE VIEW [NetO_sas].[VwWG_BRM_DEFN_GRID_DTL]
AS
   SELECT
      x.[GRIDID] AS [GRIDID],
      x.[DIM_OCC] AS [DIM_OCC],
      x.[S_GRID_VERT_HORIZ] AS [S_GRID_VERT_HORIZ],
      A0.Descript AS [S_GRID_VERT_HORIZDescription],
      x.[S_GRID_OPERATOR] AS [S_GRID_OPERATOR],
      A1.Descript AS [S_GRID_OPERATORDescription],
      ...
      A2.Descript AS [S_GRID_TGT_VAL_SPAN_TYPEDescription],
