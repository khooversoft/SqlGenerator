...
CREATE VIEW [NetO_sas].[VwGF_TSR_PNP_IPG_BASE]
AS
   SELECT
      ...
      HASHBYTES('SHA2_256', x.[SECONDARY_LOAN_TYPE]) AS [SECONDARY_LOAN_TYPE],
      ...
      A0.[Descript] AS [S_AUS_INDICATOR_X],
      x.[S_SERVICE_TYPE_IND] AS [S_SERVICE_TYPE_IND],
      A1.[Descript] AS [S_SERVICE_TYPE_IND_X],
      ...
      HASHBYTES('SHA2_256', x.[PAYFEE]) AS [PAYFEE],
      ...
      A3.[Descript] AS [S_LOANFIT_PURP_CAT_X],
      x.[S_LOANFIT_PROD_CAT] AS [S_LOANFIT_PROD_CAT],
      A4.[Descript] AS [S_LOANFIT_PROD_CAT_X],
      x.[S_LOANFIT_LIEN_CAT] AS [S_LOANFIT_LIEN_CAT],
      A5.[Descript] AS [S_LOANFIT_LIEN_CAT_X],
      ...
      A6.[Descript] AS [S_LOANFIT_AMT_GROUP_X],
      x.[S_LOANFIT_LTV_GROUP] AS [S_LOANFIT_LTV_GROUP],
      A7.[Descript] AS [S_LOANFIT_LTV_GROUP_X],
      ...
      A9.[Descript] AS [S_ASSUMABILITY_FEATURE_X],
      x.[S_IPG_BUYDWN] AS [S_IPG_BUYDWN],
      A10.[Descript] AS [S_IPG_BUYDWN_X],
      x.[S_BUYDWN_CNTRBTR] AS [S_BUYDWN_CNTRBTR],
      A11.[Descript] AS [S_BUYDWN_CNTRBTR_X]
