...
AS
   SELECT
      ...
      x.[IMPDESC],
      x.[S_REFPRP],
      A0.Descript AS [REFPRP],
      x.[IMPMADE],
      x.[LOTACQUR],
      x.[REFIIMP],
      x.[CASHAMT],
      x.[S_GSE_REFINANCE_PURPOSE],
      A1.Descript AS [GSE_REFINANCE_PURPOSE],
      x.[S_CONST_PERM_CLOSING],
      A2.Descript AS [CONST_PERM_CLOSING],
      x.[INTERNREFI],
      x.[ORIG_INVESTOR_LOAN_NBR],
      x.[S_ORIG_INVESTOR],
      A3.Descript AS [ORIG_INVESTOR],
      ...
      A4.Descript AS [CONST_PERM_FEATURE],
      x.[S_FNM_REFI_PGM],
      A5.Descript AS [FNM_REFI_PGM],
      x.[S_FRE_REFI_PGM],
      A6.Descript AS [FRE_REFI_PGM],
      x.[LIMIT_DESC],
