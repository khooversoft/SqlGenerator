...
AS
   SELECT
      ...
      x.[MATDATE],
      x.[S_SFSRC1],
      A6.Descript AS [SFSRC1],
      x.[S_SFSRC2],
      A7.Descript AS [SFSRC2],
      x.[SFAMT1],
      x.[SFAMT2],
      x.[S_BECA1],
      A8.Descript AS [BECA1],
      x.[S_BECA2],
      A9.Descript AS [BECA2],
      x.[S_BECF1],
      A10.Descript AS [BECF1],
      x.[S_BECF2],
      A11.Descript AS [BECF2],
      x.[S_DPSRC1],
      A12.Descript AS [DPSRC1],
      x.[S_DPSRC2],
      A13.Descript AS [DPSRC2],
      x.[S_DPSRC3],
      A14.Descript AS [DPSRC3],
      x.[S_DPSRC4],
      A15.Descript AS [DPSRC4],
      x.[DPAMT1],
      x.[DPAMT2],
      x.[DPAMT3],
      x.[DPAMT4],
      x.[S_CCSRC1],
      A16.Descript AS [CCSRC1],
      x.[S_CCSRC2],
      A17.Descript AS [CCSRC2],
      x.[S_CCSRC3],
      A18.Descript AS [CCSRC3],
      x.[S_CCSRC4],
      A19.Descript AS [CCSRC4],
      x.[CCAMT1],
      x.[CCAMT2],
      x.[CCAMT3],
      x.[CCAMT4],
      ...
      x.[CID_SELLER_AGENT],
      x.[S_SPF7],
      A22.Descript AS [SPF7],
      x.[S_SPF8],
      A23.Descript AS [SPF8],
      x.[S_SPF9],
      A24.Descript AS [SPF9],
      x.[S_SPF10],
      A25.Descript AS [SPF10],
      x.[UPBO],
      ...
      A26.Descript AS [INT_ACCRUAL_TYPE],
      x.[S_INT_CALC_BASIS_TYPE],
      A27.Descript AS [INT_CALC_BASITYPE],
      x.[INT_CALC_EFF_MONTHS],
      x.[S_INT_CALC_PERIOD],
      A28.Descript AS [INT_CALC_PERIOD],
      x.[S_INT_CALC_METHOD],
      A29.Descript AS [INT_CALC_METHOD],
      x.[LOAN_DELIV_GSE],
      x.[LTV_RATIO_PCT],
      x.[S_FNM_HOME_IMP_PROD],
      A30.Descript AS [FNM_HOME_IMP_PROD],
      x.[ADJ_LOAN_AMT],
      x.[ADJ_LOAN_AMT_OVRD],
      x.[APPR_DOC_ID_OVER],
      x.[MLADISCCOMPLETE],
      x.[S_SIGNDOCPUSHBACK],
      A31.Descript AS [SIGNDOCPUSHBACK],
      x.[MI_CANCELLED],
      x.[HFA_IDENTIFIER]
