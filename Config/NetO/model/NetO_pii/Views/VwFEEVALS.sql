...
CREATE VIEW [NetO_pii].[VwFEEVALS]
AS
   SELECT
      x.[LNUM],
      x.[DBCODE],
      ...
      x.[CSHMONTH],
      x.[S_PERIOD],
      A0.Descript AS [S_PERIODDescription],
      x.[TOTALATC],
      x.[INCGFE],
      x.[SPOVERRIDE],
      x.[TOTAL],
      ...
      x.[S_MISC_DESC],
      A1.Descript AS [S_MISC_DESCDescription],
      x.[LOCKEDYN],
      x.[LOCKEDTOTAL],
      x.[ISSUE_CHECK],
      x.[CREDIT_BACK],
      ...
      x.[FEECODE],
      x.[S_AGGTYPE],
      A2.Descript AS [S_AGGTYPEDescription],
      x.[S_RESP_PARTY],
      A3.Descript AS [S_RESP_PARTYDescription],
      x.[S_PAIDBY],
      A4.Descript AS [S_PAIDBYDescription],
      x.[S_PAIDTO],
      A5.Descript AS [S_PAIDTODescription],
      x.[SUBCODE],
      x.[IS_NOCOST],
      x.[MANAGED_OVR],
      x.[TO_AFFILIATE],
      x.[S_SECTION_TYPE],
      A6.Descript AS [S_SECTION_TYPEDescription],
      x.[ID_SECTION_SUBTYPE],
      x.[PREPAID_MONTH],
      x.[S_TOLERANCE_CATEGORY],
      A7.Descript AS [S_TOLERANCE_CATEGORYDescription],
      x.[S_CHANGE_TYPE],
      A8.Descript AS [S_CHANGE_TYPEDescription],
      x.[CHANGE_REASON],
      x.[BOROPT],
      x.[EXC_MAPR]
