...
AS
   SELECT
      ...
      x.[FEECODE],
      x.[S_AGGTYPE],
      A2.Descript AS [D_AGGTYPE],
      x.[S_RESP_PARTY],
      A3.Descript AS [D_RESP_PARTY],
      x.[S_PAIDBY],
      A4.Descript AS [D_PAIDBY],
      x.[S_PAIDTO],
      A5.Descript AS [D_PAIDTO],
      x.[SUBCODE],
      x.[IS_NOCOST],
      x.[MANAGED_OVR],
      x.[TO_AFFILIATE],
      x.[S_SECTION_TYPE],
      A6.Descript AS [D_SECTION_TYPE],
      x.[ID_SECTION_SUBTYPE],
      x.[PREPAID_MONTH],
      x.[S_TOLERANCE_CATEGORY],
      A7.Descript AS [D_TOLERANCE_CATEGORY],
      x.[S_CHANGE_TYPE],
      A8.Descript AS [D_CHANGE_TYPE],
      x.[CHANGE_REASON],
      x.[BOROPT],
      x.[EXC_MAPR]
