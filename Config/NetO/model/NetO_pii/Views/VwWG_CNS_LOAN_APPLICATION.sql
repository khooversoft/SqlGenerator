...
CREATE VIEW [NetO_pii].[VwWG_CNS_LOAN_APPLICATION]
AS
   SELECT
      x.[LNUM],
      x.[CID_BRANCH],
      x.[S_BUSINESS_CHANNEL],
      A0.Descript AS [D_BUSINESCHANNEL],
      x.[S_LOAN_TYPE],
      A1.Descript AS [D_LOAN_TYPE],
      x.[S_LOAN_CATEGORY],
      A2.Descript AS [D_LOAN_CATEGORY],
      x.[S_REFERRAL_SOURCE],
      A3.Descript AS [D_REFERRAL_SOURCE],
      x.[S_LOAN_PURPOSE],
      A4.Descript AS [D_LOAN_PURPOSE],
      x.[EMP_LOAN_YN],
      x.[REG_O_LOAN_YN],
      x.[TSWE_EXPECTED_YN],
      x.[TSWE_EXISTS_YN],
      ...
      A5.Descript AS [D_PRIMARY_COLLATERAL_TYPE],
      x.[COLLATERAL_STATE],
      x.[VENDOR_VAL_METHOD],
      x.[VALUATION_SOURCE],
      x.[VEHICLE_FUEL_TYPE],
      ...
      x.[COLLAGEYRS],
      x.[S_TITLE_TRANSFER],
      A6.Descript AS [D_TITLE_TRANSFER],
      x.[S_SECONDARY_COLLATERAL_TYPE],
      A7.Descript AS [D_SECONDARY_COLLATERAL_TYPE]
