...
AS
   SELECT
      ...
      A0.Descript AS [S_FIRSTTIMEHBCOUNSELDescription],
      x.[S_TITLE],
      ...
      A2.Descript AS [S_COUNSEL_CONFIRM_TYPDescription],
      x.[S_COUNSEL_CONFIRM_OTH],
      A3.Descript AS [S_COUNSEL_CONFIRM_OTHDescription],
      x.[S_COUNSEL_FORMAT_TYP],
      A4.Descript AS [S_COUNSEL_FORMAT_TYPDescription],
      x.[CREDIT_AUTHORIZATION_DATE],
      x.[CUSTOMER_ID],
      x.[S_CRDTSCORE_MODEL_OVR],
      A5.Descript AS [S_CRDTSCORE_MODEL_OVRDescription],
      x.[URLA_BESTCONTACT],
      x.[URLA_ALTCONTACT],
      x.[S_CREDIT_TYPE],
      A6.Descript AS [S_CREDIT_TYPEDescription],
      x.[JOINT_CREDIT_BNUM],
      x.[SPOUSE_FNAME],
      x.[SPOUSE_MNAME],
      x.[SPOUSE_LNAME],
      ...
      A7.Descript AS [S_LANGUAGEPREFERENCEDescription],
      x.[OTHER_LANGUAGE],
      ...
      x.[APP_DISCL_READ],
      x.[S_ELIGIBLE_TYPE],
      A8.Descript AS [S_ELIGIBLE_TYPEDescription],
      x.[ELIGIBLE_CODE],
      x.[ELIGIBLE_TEXT]
