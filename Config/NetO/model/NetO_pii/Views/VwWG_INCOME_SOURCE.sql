...
AS
   SELECT
      ...
      A0.Descript AS [INCOME_SOURCE_TYPE],
      x.[OTHER_INCOME_SRC_DESC],
      x.[S_BUSINESS_TYPE],
      A1.Descript AS [BUSINESTYPE],
      x.[SOURCE_NAME],
      x.[SOURCE_CONTACT],
      x.[ADDRESS_LN_1],
      x.[ADDRESS_LN_2],
      ...
      A2.Descript AS [SPECIAL_BOR_EMP_REL_TYPE],
