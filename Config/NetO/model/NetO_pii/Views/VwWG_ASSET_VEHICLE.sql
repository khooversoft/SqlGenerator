...
AS
   SELECT
      ...
      x.[SERIAL],
      x.[S_FUEL_TYPE],
      A0.Descript AS [D_FUEL_TYPE],
      x.[VEHICLE_REG_NUMBER],
      x.[BODY_TRIM],
      x.[S_VEHICLE_CONDITION],
      A1.Descript AS [D_VEHICLE_CONDITION],
      x.[COLL_TITLE_NUM],
      x.[S_CNRE_OWNERSHIP],
      A2.Descript AS [D_CNRE_OWNERSHIP],
      x.[LENGTH],
      x.[WIDTH],
      x.[PRIOR_TITLE_NUM],
      x.[S_TRANSF_AS],
      A3.Descript AS [D_TRANSF_AS],
      x.[S_TRANSF_TO],
      A4.Descript AS [D_TRANSF_TO],
      x.[S_DAMAGE_TYPE],
      A5.Descript AS [D_DAMAGE_TYPE],
      x.[IS_BONAFIDE_GIFT],
      x.[IS_REBUILDABLE],
      x.[IS_ENERGY_EFFICIENT],
      x.[PRIOR_STATE],
      x.[S_COLOR],
      A6.Descript AS [D_COLOR],
      x.[S_GV_WEIGHT_RATING],
      A7.Descript AS [D_GV_WEIGHT_RATING],
      x.[SCALE_WEIGHT],
      x.[PAYOFF_AMT],
      x.[MFG_REBATE],
      x.[DLR_REBATE],
