...
CREATE VIEW [NetO_pii].[VwGF_TL_LOAN_DATA]
AS
   SELECT
      x.[LNUM],
      x.[ACH_CODE],
      ...
      x.[S_INTPRD_COMM_MET],
      A3.Descript AS [D_INTPRD_COMM_MET],
      x.[EXCLUDE_FROM_QRM],
      x.[READY_REDISCLSR],
      x.[S_WELCOME_CALL],
      A4.Descript AS [D_WELCOME_CALL],
      x.[LOAN_AMOUNT_TOLER],
      x.[MAX_APPR_RATE],
      x.[S_AUS_RESULT],
      A5.Descript AS [D_AURESULT],
      x.[P_ADMINOVR],
      x.[P_CB_ADMINOVR],
      x.[P_COMPOVR],
      x.[P_CB_COMPOVR],
      ...
      A6.Descript AS [D_INIT_DISC_DELIVERY_MTHD],
      x.[CONFIDENCE_SCR_HLMAI],
      x.[S_BRANCH_TYPE],
      A7.Descript AS [D_BRANCH_TYPE],
      x.[BRANCH_ID],
      x.[BRANCH_BANK_CODE],
