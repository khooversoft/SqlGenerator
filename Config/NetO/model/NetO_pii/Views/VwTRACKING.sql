...
AS
   SELECT
      ...
      x.[CLNUM],
      x.[S_IVMETH],
      A0.Descript AS [IVMETH],
      x.[S_IVID],
      A1.Descript AS [IVID],
      x.[S_BUSCHL],
      A2.Descript AS [BUSCHL],
      x.[CLOSEDT],
      x.[DISBURDT],
      x.[FSTPMTDT],
      x.[ODDDAYS],
      x.[FEEFIRST],
      x.[S_COPT1],
      A3.Descript AS [COPT1],
      x.[S_COPT2],
      A4.Descript AS [COPT2],
      x.[S_COPT3],
      A5.Descript AS [COPT3],
      x.[S_COPT4],
      A6.Descript AS [COPT4],
      x.[S_COPT5],
      A7.Descript AS [COPT5],
      x.[CUSHION],
      x.[AGGEADJ],
      x.[DOWNPYMT],
      x.[USRID],
      ...
      x.[PREQUAL],
      x.[S_COPT6],
      A8.Descript AS [COPT6],
      x.[S_COPT7],
      A9.Descript AS [COPT7],
      x.[S_COPT8],
      A10.Descript AS [COPT8],
      x.[S_COPT9],
      A11.Descript AS [COPT9],
      x.[S_COPT10],
      A12.Descript AS [COPT10],
      x.[S_CRDGRDRQ],
      A13.Descript AS [CRDGRDRQ],
      x.[S_DOCLEVEL],
      A14.Descript AS [DOCLEVEL],
      x.[GRADEDC],
      x.[S_CRDGRDAP],
      A15.Descript AS [CRDGRDAP],
      x.[S_QUALITY],
      A16.Descript AS [QUALITY],
      x.[DMSGRADE],
      x.[ESTCLOSD],
      x.[SRVCNUM],
      x.[OWN_NAME],
      ...
      x.[PURPOSE_TYPE],
      x.[S_CASE_STATUS],
      A18.Descript AS [CASE_STATUS],
      x.[S_REPAY],
      A19.Descript AS [REPAY],
      x.[UNITPER],
      x.[UNITPEROVR],
      x.[LASTLOCKED],
      x.[BLANKETLOAN],
      ...
      A20.Descript AS [CHANNEL_SOURCE_CODE],
      x.[RECORD_CREATED],
      x.[LOAN_CREATE_DATE],
