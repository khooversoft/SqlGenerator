...
CREATE VIEW [NetO_pii].[VwWG_BRM_DEFN_FIELDS]
AS
   SELECT
      x.[FIELDID],
      x.[S_FIELD_STATUS],
      A0.Descript AS [D_FIELD_STATUS],
      x.[FIELD_NAME],
      x.[FIELD_TEXT],
      x.[S_FIELD_CONTROL_TYPE],
      A1.Descript AS [D_FIELD_CONTROL_TYPE],
      x.[S_FIELD_OPERATOR],
      A2.Descript AS [D_FIELD_OPERATOR],
      x.[S_FIELD_LIST_SOURCE],
      A3.Descript AS [D_FIELD_LIST_SOURCE],
      x.[S_FIELD_FORMAT],
      A4.Descript AS [D_FIELD_FORMAT],
      x.[CURRENT_USER_DATETIME],
      x.[CURRENT_USER_ID],
      x.[S_USAGE_TYPE],
      A5.Descript AS [D_USAGE_TYPE]
