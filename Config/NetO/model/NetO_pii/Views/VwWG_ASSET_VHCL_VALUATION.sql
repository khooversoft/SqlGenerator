...
CREATE VIEW [NetO_pii].[VwWG_ASSET_VHCL_VALUATION]
AS
   SELECT
      x.[LNUM],
      x.[ASSETID],
      ...
      A0.Descript AS [S_VALUATION_SOURCEDescription],
      ...
      x.[REGION],
      x.[S_CLEAN_LEVEL],
      A1.Descript AS [S_CLEAN_LEVELDescription],
      x.[S_USE_FOR_LOAN_VAL],
      A2.Descript AS [S_USE_FOR_LOAN_VALDescription],
