...
SELECT 'clt_neto', 'ACTIVITY', 'S_ACTIVI', 1
UNION ALL
...
UNION ALL
SELECT 'clt_neto', 'ASSOCDOCS', 'S_SUNDCON', 1
UNION ALL
SELECT 'clt_neto', 'ASSOCDOCS', 'CNTR', 2
UNION ALL
...
UNION ALL
SELECT 'clt_neto', 'FIELD_HISTORY', 'PKFIX', 2
UNION ALL
...
UNION ALL
SELECT 'clt_neto', 'GF_TLB_EQ_RES_SUMMARY', 'LNUM', 1
UNION ALL
SELECT 'clt_neto', 'GF_TLB_EQ_RES_SUMMARY', 'BNUM', 2
UNION ALL
SELECT 'clt_neto', 'GF_TLB_EQ_RES_SUMMARY', 'DBID', 3
UNION ALL
SELECT 'clt_neto', 'GF_TLB_EQ_RES_SUMMARY', 'RESPONSEID', 4
UNION ALL
SELECT 'clt_neto', 'GF_TLB_EQ_RES_SUMMARY', 'CREDITRESPONSEID', 5
UNION ALL
SELECT 'clt_neto', 'GF_TLB_EX_RES_PROF_SUM', 'LNUM', 1
UNION ALL
SELECT 'clt_neto', 'GF_TLB_EX_RES_PROF_SUM', 'BNUM', 2
UNION ALL
SELECT 'clt_neto', 'GF_TLB_EX_RES_PROF_SUM', 'DBID', 3
UNION ALL
SELECT 'clt_neto', 'GF_TLB_EX_RES_PROF_SUM', 'RESPONSEID', 4
UNION ALL
SELECT 'clt_neto', 'GF_TLB_EX_RES_PROF_SUM', 'CREDITRESPONSEID', 5
UNION ALL
...
UNION ALL
SELECT 'clt_neto', 'GF_TLB_TU_RES_SCORING', 'LNUM', 1
UNION ALL
SELECT 'clt_neto', 'GF_TLB_TU_RES_SCORING', 'BNUM', 2
UNION ALL
SELECT 'clt_neto', 'GF_TLB_TU_RES_SCORING', 'DBID', 3
UNION ALL
SELECT 'clt_neto', 'GF_TLB_TU_RES_SCORING', 'RESPONSEID', 4
UNION ALL
SELECT 'clt_neto', 'GF_TLB_TU_RES_SCORING', 'CREDITRESPONSEID', 5
UNION ALL
SELECT 'clt_neto', 'GF_TLB_TU_RES_SUBJ_INFO', 'LNUM', 1
UNION ALL
SELECT 'clt_neto', 'GF_TLB_TU_RES_SUBJ_INFO', 'BNUM', 2
UNION ALL
SELECT 'clt_neto', 'GF_TLB_TU_RES_SUBJ_INFO', 'DBID', 3
UNION ALL
SELECT 'clt_neto', 'GF_TLB_TU_RES_SUBJ_INFO', 'RESPONSEID', 4
UNION ALL
SELECT 'clt_neto', 'GF_TLB_TU_RES_SUBJ_INFO', 'CREDITRESPONSEID', 5
UNION ALL
...
UNION ALL
SELECT 'clt_neto', 'GF_TLBC_EX_RES_INQUIRY', 'LNUM', 1
UNION ALL
SELECT 'clt_neto', 'GF_TLBC_EX_RES_INQUIRY', 'BNUM', 2
UNION ALL
SELECT 'clt_neto', 'GF_TLBC_EX_RES_INQUIRY', 'DBID', 3
UNION ALL
SELECT 'clt_neto', 'GF_TLBC_EX_RES_INQUIRY', 'ROWCOUNTER', 4
UNION ALL
SELECT 'clt_neto', 'GF_TLBC_EX_RES_INQUIRY', 'RESPONSEID', 5
UNION ALL
SELECT 'clt_neto', 'GF_TLBC_EX_RES_INQUIRY', 'CREDITRESPONSEID', 6
UNION ALL
...
UNION ALL
SELECT 'clt_neto', 'GF_TLBR_CREDIT_SCORE', 'BORROWER_ID', 6
UNION ALL
...
UNION ALL
SELECT 'clt_neto', 'GF_TLR_CREDIT_RESPONSE', 'LNUM', 1
UNION ALL
SELECT 'clt_neto', 'GF_TLR_CREDIT_RESPONSE', 'RESPONSEID', 2
UNION ALL
SELECT 'clt_neto', 'GF_TLR_CREDIT_RESPONSE', 'CREDITRESPONSEID', 3
UNION ALL
SELECT 'clt_neto', 'GF_TLR_CREDIT_RESPONSE', 'DBID', 4
UNION ALL
...
UNION ALL
SELECT 'clt_neto', 'GF_TLR_REQ_CREDIT_DATA', 'LNUM', 1
UNION ALL
SELECT 'clt_neto', 'GF_TLR_REQ_CREDIT_DATA', 'REQUESTID', 2
UNION ALL
SELECT 'clt_neto', 'GF_TLR_REQ_CREDIT_DATA', 'CREDITREQUESTID', 3
UNION ALL
SELECT 'clt_neto', 'GF_TLR_REQ_CREDIT_DATA', 'DATAID', 4
UNION ALL
SELECT 'clt_neto', 'GF_TLR_REQ_CREDIT_DATA', 'DBID', 5
UNION ALL
...
UNION ALL
SELECT 'clt_neto', 'GF_TLR_RES_TITLE_TAX', 'LNUM', 1
UNION ALL
SELECT 'clt_neto', 'GF_TLR_RES_TITLE_TAX', 'RESPONSEID', 2
UNION ALL
SELECT 'clt_neto', 'GF_TLR_RES_TITLE_TAX', 'DBID', 3
UNION ALL
SELECT 'clt_neto', 'GF_TLR_RES_TITLE_TAX', 'TITLERESPONSEID', 4
UNION ALL
...
UNION ALL
SELECT 'clt_neto', 'GF_TS_AUDIT_LOAN_DELETE', 'USRID', 2
UNION ALL
SELECT 'clt_neto', 'GF_TS_AUDIT_USER_LOCK', 'UL_ID', 1
UNION ALL
SELECT 'clt_neto', 'GF_TS_CMS_APPROVAL_DTL', 'CID', 1
UNION ALL
SELECT 'clt_neto', 'GF_TS_CMS_APPROVAL_DTL', 'S_CMSTYPE', 2
UNION ALL
SELECT 'clt_neto', 'GF_TS_CMS_APPROVAL_DTL', 'S_APPROVEDCO', 3
UNION ALL
...
UNION ALL
SELECT 'clt_neto', 'RATECODE', 'USEKEY', 1
UNION ALL
SELECT 'clt_neto', 'RATECODE', 'CURRENTCODE', 2
UNION ALL
SELECT 'clt_neto', 'RATECODE', 'RATECODE', 3
UNION ALL
SELECT 'clt_neto', 'RATECODE', 'COUNTER', 4
UNION ALL
...
UNION ALL
SELECT 'clt_neto', 'SEIA', 'DBID', 6
UNION ALL
SELECT 'clt_neto', 'SEIA', 'CTR', 7
UNION ALL
...
UNION ALL
SELECT 'clt_neto', 'VESTING', 'LNUM', 1
UNION ALL
SELECT 'clt_neto', 'VETINFO', 'LNUM', 1
UNION ALL
SELECT 'clt_neto', 'VETINFO', 'BNUM', 2
UNION ALL
SELECT 'clt_neto', 'VETINFO', 'DBID', 3
UNION ALL
...
UNION ALL
SELECT 'clt_neto', 'WG_ASSET_VHCL_OPTIONS', 'VALUATION_CNTR', 4
UNION ALL
...
UNION ALL
SELECT 'clt_neto', 'WG_BORR_INCOME_SRC_PAYSTUB', 'LNUM', 1
UNION ALL
SELECT 'clt_neto', 'WG_BORR_INCOME_SRC_PAYSTUB', 'BNUM', 2
UNION ALL
SELECT 'clt_neto', 'WG_BORR_INCOME_SRC_PAYSTUB', 'DBID', 3
UNION ALL
SELECT 'clt_neto', 'WG_BORR_INCOME_SRC_PAYSTUB', 'PS_CTR', 4
UNION ALL
SELECT 'clt_neto', 'WG_BORR_INCOME_SRC_PAYSTUB', 'INC_SRC_CTR', 5
UNION ALL
...
UNION ALL
SELECT 'clt_neto', 'WG_COLLATERAL_TRADEIN', 'TRDINCNTR', 2
UNION ALL
...
UNION ALL
SELECT 'clt_neto', 'WG_LOAN_EXCEPTIONS', 'LNUM', 1
UNION ALL
SELECT 'clt_neto', 'WG_LOAN_EXCEPTIONS', 'DBID', 2
UNION ALL
SELECT 'clt_neto', 'WG_LOAN_EXCEPTIONS', 'ROWSERIALNO', 3
UNION ALL
SELECT 'clt_neto', 'WG_PRICE_EXCEPTIONS', 'LNUM', 1
UNION ALL
SELECT 'clt_neto', 'WG_PRICE_EXCEPTIONS', 'EXCEPTIONID', 2
UNION ALL
SELECT 'clt_neto', 'WG_PROMOTION', 'PROMO_ID', 1
UNION ALL
...
UNION ALL
SELECT 'clt_neto', 'WG_RPT_LOAN_REMARKS', 'RMKID', 2
UNION ALL
...
UNION ALL
SELECT 'clt_neto', 'WG_SC_DECISION_REASON', 'LNUM', 1
UNION ALL
SELECT 'clt_neto', 'WG_SC_DECISION_REASON', 'DECISION_INDICATOR', 2
UNION ALL
SELECT 'clt_neto', 'WG_SC_DECISION_REASON', 'BNUM', 3
UNION ALL
SELECT 'clt_neto', 'WG_SC_DECISION_REASON', 'DBID', 4
UNION ALL
SELECT 'clt_neto', 'WG_SC_DECISION_REASON', 'RSN_CTR', 5
UNION ALL
SELECT 'clt_neto', 'WG_SYMBOL_XREF', 'TABLENAME', 1
UNION ALL
SELECT 'clt_neto', 'WG_SYMBOL_XREF', 'COLUMNNAME', 2
UNION ALL
SELECT 'clt_neto', 'WG_SYMBOL_XREF', 'FLDNAME', 3
UNION ALL
...
UNION ALL
SELECT 'clt_neto', 'WG_TLR_RECORDING_INFO', 'LNUM', 1
UNION ALL
SELECT 'clt_neto', 'WG_TLR_RECORDING_INFO', 'DBID', 2
UNION ALL
SELECT 'clt_neto', 'WG_TLR_RECORDING_INFO', 'ROWSERIALNO', 3
;
