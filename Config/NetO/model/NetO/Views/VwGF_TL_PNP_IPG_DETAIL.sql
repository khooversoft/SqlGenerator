...
AS
   SELECT
      ...
      x.[IPG_NAME],
      x.[S_SEC_MANAGE_TYPE],
      A0.Descript AS [D_SEC_MANAGE_TYPE],
      x.[S_SEC_LOAN_TYPE],
      A1.Descript AS [D_SEC_LOAN_TYPE],
      x.[S_SEC_POOL_TYPE],
      A2.Descript AS [D_SEC_POOL_TYPE],
      x.[S_PREPAY_PEN],
      A3.Descript AS [D_PREPAY_PEN],
      x.[OVER_ALLOW_PCT],
      x.[SHORT_ALLOW_PCT],
      x.[OVER_SPLIT_PCT],
      x.[SHORT_SPLIT_PCT],
      ...
      x.[S_AUS_IND],
      A4.Descript AS [D_AUIND],
      x.[S_SERVICE_TYPE],
      A5.Descript AS [D_SERVICE_TYPE],
      ...
      A7.Descript AS [D_ASSUMABILITY_FEATURE]
