...
AS
   SELECT
      ...
      x.[ASSETID],
      x.[S_MARINE_TYPE],
      A0.Descript AS [MARINE_TYPE],
      x.[BOAT_NAME],
      x.[NET_WEIGHT],
      x.[S_PROPULSION_TYPE],
      A1.Descript AS [PROPULSION_TYPE],
      x.[HAILING_PORT],
      x.[MOORING_ADDR1],
      x.[MOORING_ADDR2],
      x.[MOORING_CITY],
      ...
      x.[TRAILER_ASSETID],
      x.[S_FUEL_TYPE],
      A2.Descript AS [FUEL_TYPE],
      x.[BEAM],
      x.[MARINE_LENGTH],
      x.[S_HULL_MATERIAL],
      A3.Descript AS [HULL_MATERIAL],
      x.[S_PRIMARY_USE],
      A4.Descript AS [PRIMARY_USE],
      x.[S_ENGINE_DRIVE],
      A5.Descript AS [ENGINE_DRIVE],
      x.[IS_DOCUMENTED_VESSEL],
      x.[USCG_OFFICIAL_NUMBER],
      x.[S_MANUF_TYPE],
      A6.Descript AS [MANUF_TYPE],
      x.[TOILETATTACHED],
      x.[MATLOTHDESC],
      x.[FUELOTHDESC],
      x.[PROPOTHDESC],
