...
AS
   SELECT
      ...
      x.[ASSETID],
      x.[S_MARINE_TYPE],
      A0.Descript AS [S_MARINE_TYPEDescription],
      x.[BOAT_NAME],
      x.[NET_WEIGHT],
      x.[S_PROPULSION_TYPE],
      A1.Descript AS [S_PROPULSION_TYPEDescription],
      x.[HAILING_PORT],
      x.[MOORING_ADDR1],
      x.[MOORING_ADDR2],
      x.[MOORING_CITY],
      ...
      x.[TRAILER_ASSETID],
      x.[S_FUEL_TYPE],
      A2.Descript AS [S_FUEL_TYPEDescription],
      x.[BEAM],
      x.[MARINE_LENGTH],
      x.[S_HULL_MATERIAL],
      A3.Descript AS [S_HULL_MATERIALDescription],
      x.[S_PRIMARY_USE],
      A4.Descript AS [S_PRIMARY_USEDescription],
      x.[S_ENGINE_DRIVE],
      A5.Descript AS [S_ENGINE_DRIVEDescription],
      x.[IS_DOCUMENTED_VESSEL],
      x.[USCG_OFFICIAL_NUMBER],
      x.[S_MANUF_TYPE],
      A6.Descript AS [S_MANUF_TYPEDescription],
      x.[TOILETATTACHED],
      x.[MATLOTHDESC],
      x.[FUELOTHDESC],
      x.[PROPOTHDESC],
