...
AS
   SELECT
      ...
      x.[S_UNDCAT],
      A1.Descript AS [D_UNDCAT],
      x.[S_UNDTYP],
      A2.Descript AS [D_UNDTYP],
      x.[CUUSRID],
      x.[CUUSGRP],
      x.[CUDATE],
      ...
      x.[ISACTIVE],
      x.[S_ASSOCDOC],
      A3.Descript AS [D_ASSOCDOC],
      x.[SHWWAIVE],
      x.[DISCLOSE],
      x.[S_COMFLG],
      A4.Descript AS [D_COMFLG],
      x.[RESPONSIBLE_P],
      x.[DUEDATE],
      x.[ERRORCAUSEBY],
      x.[S_CONDITION_SRC],
      A5.Descript AS [D_CONDITION_SRC],
      x.[CREATED_DATE],
      x.[CREATED_USER],
      x.[RECEIVED_DT],
      x.[IMGSTATUS],
