...
CREATE VIEW [NetO].[VwGF_TL_POINT_OF_SALE_INFO]
AS
   SELECT
      x.[LNUM],
      x.[S_REFSC],
      A0.Descript AS [S_REFSCDescription],
      x.[TBDADDR],
      x.[POSFHA],
      x.[S_PROPTYPE],
      A1.Descript AS [S_PROPTYPEDescription],
      x.[PROJCLAS],
      x.[PROJNAME],
      x.[DPPERCT],
      x.[HELINE],
      x.[HECURBAL],
      x.[S_DOCLVL],
      A2.Descript AS [S_DOCLVLDescription],
      x.[S_LNSTATUS],
      A3.Descript AS [S_LNSTATUSDescription],
      x.[HLTVH],
      x.[TSWE_INC_EXPECTED],
      x.[QUAL_TSWE_LOAN],
      x.[LNSTATUS_DT],
      ...
      x.[LO_PHONE_OVR],
      x.[S_GFE_TIME_ZONE],
      A4.Descript AS [S_GFE_TIME_ZONEDescription],
      x.[ALLOWWITHDRAWLOAN],
      x.[GFE_INT_RATE_LSC],
      x.[GFE_INT_RATE_LIR],
      x.[GFE_SET_CHRG_LSC],
