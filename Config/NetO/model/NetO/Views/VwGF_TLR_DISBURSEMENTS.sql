...
CREATE VIEW [NetO].[VwGF_TLR_DISBURSEMENTS]
AS
   SELECT
      x.[LNUM],
      x.[DBID],
      ...
      x.[MODIFIED_USERID],
      x.[S_FMETHOD],
      A0.Descript AS [S_FMETHODDescription],
      x.[S_FSTATUS],
      A1.Descript AS [S_FSTATUSDescription],
      x.[S_DMETHOD],
      A2.Descript AS [S_DMETHODDescription],
      x.[AMOUNT],
      ...
      x.[REQDATE],
      x.[S_TYPE],
      A3.Descript AS [S_TYPEDescription],
      x.[S_FUNDLOC],
      A4.Descript AS [S_FUNDLOCDescription],
      x.[ROUTENUM],
      x.[ACCOUNTNUM],
      x.[TRANSNUM],
      x.[TRANSREF],
