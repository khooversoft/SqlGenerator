...
AS
   SELECT
      ...
      x.[SUBJMHLD],
      x.[S_OWNRHT],
      A0.Descript AS [OWNRHT],
      x.[SUBJOREX],
      x.[SUBJLPRI],
      x.[SUBJAV],
      x.[SUBJSP],
      x.[S_PRPTYP],
      A1.Descript AS [PRPTYP],
      x.[SUBJSCFN],
      x.[S_DPAYMT],
      A2.Descript AS [DPAYMT],
      x.[S_RESTYP],
      A3.Descript AS [RESTYP],
      x.[SUBJESTE],
      x.[SUBJLEXP],
      x.[SUBJCNTY],
      x.[LOTNUM],
      ...
      x.[MSACODE],
      x.[S_LIENPO],
      A5.Descript AS [LIENPO],
      x.[S_LIENHO],
      A6.Descript AS [LIENHO],
      x.[BALOTHMT],
      x.[SUBJLTV],
      x.[COMBLTV],
      x.[CENTRACT],
      ...
      x.[PROPTYPEOTHER],
      x.[S_FREPRJCLS],
      A8.Descript AS [FREPRJCLS],
      x.[S_FNMPRJCLS],
      A9.Descript AS [FNMPRJCLS],
      x.[HOTEL_INDICATOR],
      x.[NONWARRANTABLE],
      x.[NUMBSTORIES],
      x.[HOMESTEAD],
      ...
      x.[CPMPROID],
      x.[S_FRPROJ],
      A23.Descript AS [FRPROJ],
      x.[S_FMPROJ],
      A24.Descript AS [FMPROJ],
      x.[PROPDESC],
      x.[RENTINC_VERIFIED],
      ...
      x.[S_APPRMTHDREQ],
      A27.Descript AS [APPRMTHDREQ],
      x.[S_APPRMTHDREQOVR],
      A28.Descript AS [APPRMTHDREQOVR],
      x.[EXIST_EEM_AMT],
      x.[ISCONDOMINIUM],
      x.[ISCOOPERATIVE],
      x.[ISPUD],
