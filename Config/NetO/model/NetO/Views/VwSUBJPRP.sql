...
AS
   SELECT
      ...
      x.[SUBJMHLD],
      x.[S_OWNRHT],
      A0.Descript AS [S_OWNRHTDescription],
      x.[SUBJOREX],
      x.[SUBJLPRI],
      x.[SUBJAV],
      x.[SUBJSP],
      x.[S_PRPTYP],
      A1.Descript AS [S_PRPTYPDescription],
      x.[SUBJSCFN],
      x.[S_DPAYMT],
      A2.Descript AS [S_DPAYMTDescription],
      x.[S_RESTYP],
      A3.Descript AS [S_RESTYPDescription],
      x.[SUBJESTE],
      x.[SUBJLEXP],
      x.[SUBJCNTY],
      x.[LOTNUM],
      ...
      x.[SUBDIV],
      x.[S_PURP],
      A4.Descript AS [S_PURPDescription],
      x.[STCODE],
      x.[CYCODE],
      x.[MSACODE],
      x.[S_LIENPO],
      A5.Descript AS [S_LIENPODescription],
      x.[S_LIENHO],
      A6.Descript AS [S_LIENHODescription],
      x.[BALOTHMT],
      x.[SUBJLTV],
      x.[COMBLTV],
      x.[CENTRACT],
      ...
      x.[CITYFLAG],
      x.[S_PRJCLS],
      A7.Descript AS [S_PRJCLSDescription],
      x.[PROJNAME],
      x.[DECLDBID],
      x.[DECLSERL],
      x.[UNITNUM],
      ...
      x.[PROPTYPEOTHER],
      x.[S_FREPRJCLS],
      A8.Descript AS [S_FREPRJCLSDescription],
      x.[S_FNMPRJCLS],
      A9.Descript AS [S_FNMPRJCLSDescription],
      x.[HOTEL_INDICATOR],
      x.[NONWARRANTABLE],
      x.[NUMBSTORIES],
      x.[HOMESTEAD],
      ...
      A10.Descript AS [S_UNIQUEDWELLINGTYPEDescription],
      x.[OTHERUNIQDWELLINGTYPDSC],
      x.[S_NATIVEAMERICANLANDSTYPE],
      A11.Descript AS [S_NATIVEAMERICANLANDSTYPEDescription],
      x.[OTHERNATAMERLANDSTYPEDESC],
      x.[COMMLANDTRUSTINDCTR],
      x.[INCLUSIONARYZONEINDCTR],
      x.[S_CATEGORYTYPE],
      A12.Descript AS [S_CATEGORYTYPEDescription],
      x.[OTHERCATEGORYTYPEDESC],
      x.[S_PROJECTDESIGNTYPE],
      A13.Descript AS [S_PROJECTDESIGNTYPEDescription],
      x.[OTHERPROJDESIGNTYPEDESC],
      x.[S_PROJECTCLASSTYPE],
      A14.Descript AS [S_PROJECTCLASSTYPEDescription],
      x.[OTHERPROJCLASSTYPEDESC],
      x.[OTHERDOWNPAYTYPEDESC],
      x.[S_UNITOWNERSHIPTYPE],
      A15.Descript AS [S_UNITOWNERSHIPTYPEDescription],
      x.[CONCURRENT_FIN_INPUT],
      x.[INCLUDE_ASSIST_PROGS],
      x.[S_DPAYMTNM],
      A16.Descript AS [S_DPAYMTNMDescription],
      x.[DOWNPAYNMDESC],
      x.[SUBESTAV],
      x.[LTV_ROUNDED],
      x.[TLTV_ROUNDED],
      x.[S_CONDO_PROJECT_STATUS],
      A17.Descript AS [S_CONDO_PROJECT_STATUSDescription],
      x.[S_PROJ_ATTACH_TYPE],
      A18.Descript AS [S_PROJ_ATTACH_TYPEDescription],
      x.[S_PROJECT_DESIGN_TYPE],
      A19.Descript AS [S_PROJECT_DESIGN_TYPEDescription],
      x.[S_ATTACHMENT_TYPE],
      A20.Descript AS [S_ATTACHMENT_TYPEDescription],
      x.[S_PROJ_CLASS_ID_FNM],
      A21.Descript AS [S_PROJ_CLASS_ID_FNMDescription],
      x.[S_PROJ_CLASS_ID_FRE],
      A22.Descript AS [S_PROJ_CLASS_ID_FREDescription],
      x.[PROJ_UNITS_TOTAL],
      x.[PROJ_UNITS_SOLD],
      x.[ISUSPSVALIDATED],
      x.[SUBJADD3],
      x.[CPMPROID],
      x.[S_FRPROJ],
      A23.Descript AS [S_FRPROJDescription],
      x.[S_FMPROJ],
      A24.Descript AS [S_FMPROJDescription],
      x.[PROPDESC],
      x.[RENTINC_VERIFIED],
      ...
      x.[S_STRUCTURETYPE],
      A25.Descript AS [S_STRUCTURETYPEDescription],
      x.[CEMA],
      x.[FHAHUDAPPROVAL],
      x.[IMP_COST_PLUS_EEM],
      ...
      x.[S_SUBJUNITTYPE],
      A26.Descript AS [S_SUBJUNITTYPEDescription],
      x.[CRAEXEMPTION],
      x.[MDINDICATOR],
      x.[MSAINDICATOR],
      x.[SMALLPOPULATION],
      ...
      x.[S_APPRMTHDREQ],
      A27.Descript AS [S_APPRMTHDREQDescription],
      x.[S_APPRMTHDREQOVR],
      A28.Descript AS [S_APPRMTHDREQOVRDescription],
      x.[EXIST_EEM_AMT],
      x.[ISCONDOMINIUM],
      x.[ISCOOPERATIVE],
      x.[ISPUD],
      ...
      x.[TX_50A6],
      x.[S_TRSTYP],
      A29.Descript AS [S_TRSTYPDescription],
