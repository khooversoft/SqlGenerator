...
CREATE VIEW [NetO].[VwWG_ASSET_VEHICLE]
AS
   SELECT
      x.[LNUM],
      x.[ASSETID],
      ...
      x.[MSRP],
      x.[NEW_YN],
      HASHBYTES('SHA2_256', x.[SERIAL]) AS [SERIAL],
      x.[S_FUEL_TYPE],
      A0.[Descript] AS [S_FUEL_TYPE_X],
      HASHBYTES('SHA2_256', x.[VEHICLE_REG_NUMBER]) AS [VEHICLE_REG_NUMBER],
      x.[BODY_TRIM],
      x.[S_VEHICLE_CONDITION],
      A1.[Descript] AS [S_VEHICLE_CONDITION_X],
      x.[COLL_TITLE_NUM],
      x.[S_CNRE_OWNERSHIP],
      A2.[Descript] AS [S_CNRE_OWNERSHIP_X],
      x.[LENGTH],
      x.[WIDTH],
      HASHBYTES('SHA2_256', x.[PRIOR_TITLE_NUM]) AS [PRIOR_TITLE_NUM],
      x.[S_TRANSF_AS],
      A3.[Descript] AS [S_TRANSF_AS_X],
      x.[S_TRANSF_TO],
      A4.[Descript] AS [S_TRANSF_TO_X],
      x.[S_DAMAGE_TYPE],
      A5.[Descript] AS [S_DAMAGE_TYPE_X],
      x.[IS_BONAFIDE_GIFT],
      x.[IS_REBUILDABLE],
      x.[IS_ENERGY_EFFICIENT],
      HASHBYTES('SHA2_256', x.[PRIOR_STATE]) AS [PRIOR_STATE],
      x.[S_COLOR],
      A6.[Descript] AS [S_COLOR_X],
      x.[S_GV_WEIGHT_RATING],
      A7.[Descript] AS [S_GV_WEIGHT_RATING_X],
      x.[SCALE_WEIGHT],
      x.[PAYOFF_AMT],
      x.[MFG_REBATE],
      x.[DLR_REBATE],
