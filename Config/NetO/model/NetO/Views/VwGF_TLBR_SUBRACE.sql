...
CREATE VIEW [NetO].[VwGF_TLBR_SUBRACE]
AS
   SELECT
      x.[LNUM],
      x.[BNUM],
      ...
      HASHBYTES('SHA2_256', x.[OTHER_ASIAN_DESC]) AS [OTHER_ASIAN_DESC],
      HASHBYTES('SHA2_256', x.[OTHER_PACISLDR_DESC]) AS [OTHER_PACISLDR_DESC],
      x.[RECORD_CREATED]
