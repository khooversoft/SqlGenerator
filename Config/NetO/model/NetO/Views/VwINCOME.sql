...
AS
   SELECT
      ...
      x.[PRIMINC],
      x.[S_INCOME],
      A0.Descript AS [S_INCOMEDescription],
      x.[S_PAYPER],
      A1.Descript AS [S_PAYPERDescription],
      x.[INCAMT],
      x.[INCDESC],
      x.[MNTEQUIV],
      x.[USEQUAL],
      ...
      x.[EFFECTIVE_MO_INC],
      x.[S_JOB_TYPE],
      A2.Descript AS [S_JOB_TYPEDescription],
      x.[OVRTIME_CONT],
      x.[PROB_CONT_EMPLOY],
      x.[OTHERINCTYPEDESC],
      x.[S_SPECBOREMPRELTYPE],
      A3.Descript AS [S_SPECBOREMPRELTYPEDescription],
      ...
      x.[RECORD_CREATED],
      x.[S_INCOMECATEGORY],
      A4.Descript AS [S_INCOMECATEGORYDescription],
      x.[OCCUPATION],
      x.[INCSTIND],
      x.[S_SELFEMPTYPE],
      A5.Descript AS [S_SELFEMPTYPEDescription],
