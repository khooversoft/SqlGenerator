...
AS
   SELECT
      ...
      x.[DBID],
      x.[RESCTR],
      HASHBYTES('SHA2_256', x.[RESADD1]) AS [RESADD1],
      HASHBYTES('SHA2_256', x.[RESADD2]) AS [RESADD2],
      HASHBYTES('SHA2_256', x.[RESCITY]) AS [RESCITY],
      x.[RESST],
      HASHBYTES('SHA2_256', x.[RESZIP]) AS [RESZIP],
      x.[S_OWNRNT],
      A0.[Descript] AS [S_OWNRNT_X],
      x.[RESNMYRS],
      x.[ACCTPREV],
      x.[ACCTHLDR],
      HASHBYTES('SHA2_256', x.[RESCNTRY]) AS [RESCNTRY],
      x.[LANDCTR],
      HASHBYTES('SHA2_256', x.[RESCNTY]) AS [RESCNTY],
      ...
      x.[RES_UNIT_NUM],
      HASHBYTES('SHA2_256', x.[RES_CNTRY_CODE]) AS [RES_CNTRY_CODE],
      x.[PREV_STATE_FOREIN],
      x.[PREV_POSTCODE],
