...
AS
   SELECT
      ...
      x.[REOZIP],
      x.[S_REOPST],
      A0.Descript AS [D_REOPST],
      x.[S_REOTYP],
      A1.Descript AS [D_REOTYP],
      x.[PRESVAL],
      x.[PRESMTG],
      x.[GROSRENT],
      x.[MTGPYMT],
      ...
      A3.Descript AS [D_ACCOUNT_OWNERSHIP],
      x.[XPROCEEDOVR],
      x.[S_REO_INTEND_OCCUPANCY],
      A4.Descript AS [D_REO_INTEND_OCCUPANCY],
      x.[REO_OTHROCCUP_DESC],
      x.[S_REO_CURR_PROP_USAGE],
      A5.Descript AS [D_REO_CURR_PROP_USAGE],
      x.[REO_STATE_FOREIN],
      x.[REO_POSTCODE],
      x.[REO_CNTRY_COD],
      x.[RECORD_CREATED]
