...
AS
   SELECT
      ...
      A0.Descript AS [D_INCOME_SOURCE_TYPE],
      x.[OTHER_INCOME_SRC_DESC],
      x.[S_BUSINESS_TYPE],
      A1.Descript AS [D_BUSINESTYPE],
      x.[SOURCE_NAME],
      x.[SOURCE_CONTACT],
      x.[ADDRESS_LN_1],
      x.[ADDRESS_LN_2],
      ...
      A2.Descript AS [D_SPECIAL_BOR_EMP_REL_TYPE],
      ...
      x.[S_SELF_EMPL_TYPE],
      A3.Descript AS [D_SELF_EMPL_TYPE],
      x.[PROF_MONTHS],
      x.[PROF_YEARS],
      x.[BASE_INCOME],
      x.[BONUS_INCOME],
      ...
      x.[LIABCTR],
      x.[S_EMP_UNIT_TYPE],
      A4.Descript AS [D_EMP_UNIT_TYPE],
      x.[EMP_UNIT_NUMBER],
