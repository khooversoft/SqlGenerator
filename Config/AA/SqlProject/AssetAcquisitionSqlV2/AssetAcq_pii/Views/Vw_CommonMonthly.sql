...
AS
   SELECT
      ...
      coalesce(x.[Total30DaysDQLifeOfLoanCount], 0) AS [Total30DaysDQLifeOfLoanCount],
      coalesce(x.[Total60DaysDQLifeOfLoanCount], 0) AS [Total60DaysDQLifeOfLoanCount],
      coalesce(x.[Total90DaysDQLifeOfLoanCount], 0) AS [Total90DaysDQLifeOfLoanCount],
      coalesce(x.[Total120DaysDQLifeOfLoanCount], 0) AS [Total120DaysDQLifeOfLoanCount],
      coalesce(x.[Total180DaysDQLifeOfLoanCount], 0) AS [Total180DaysDQLifeOfLoanCount],
      x.[CurrentTDRFlag],
