CREATE TABLE [clt_Alkami].[product_category_content]
(
   [product_category_content_id]       varchar(40)          NOT NULL,
   [ASAP_RecordEffectiveDateTime]      datetime2(7)         NOT NULL,
   [ASAP_DeleteDateTime]               nvarchar(10)         NULL,
   [product_category_id]               varchar(40)          NULL,
   [content_location]                  text                 NULL,
   [category_content_type_enum_id]     varchar(40)          NULL,
...
WITH (DISTRIBUTION = HASH ([product_category_content_id]), CLUSTERED COLUMNSTORE INDEX)
;
